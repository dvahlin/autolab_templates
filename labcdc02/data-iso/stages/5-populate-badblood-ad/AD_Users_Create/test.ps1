...
write-host "Creating Users on Domain" -ForegroundColor Green
    $NumOfUsers = 50..200|Get-random #this number is the random number of users to create on a domain.
    $X=1
...
$OUsAll = get-adobject -Filter {Name -eq 'Users' -and objectclass -eq 'organizationalunit'} -ResultSetSize 300
...
#service
$nameSuffix = "SA"
$description = 'Labbverksamheten SA'
do {
    $checkAcct= $null
